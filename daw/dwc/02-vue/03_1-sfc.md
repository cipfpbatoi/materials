...
Lo que hace es importar los componentes que se utilizan en el template. Está en forma de _Composition API_. En forma de _Options API_ sería:
...
- **name**: el nombre del componente. Es recomendable ponerlo, aunque sólo es obligatorio en caso de componentes recursivos. Es el nombre con el que se referenciará al componente en la consola del navegador usndo las _Dev tools_.
