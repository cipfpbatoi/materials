...
- [Single File Components](#single-file-components)
  - [Introducción](#introducción)
    - [Definir el componente en su propio fichero](#definir-el-componente-en-su-propio-fichero)
...
### Definir el componente en su propio fichero
En el fichero en que definimos el componente NO lo creamos sino que simplemente exportamos el objeto con las opciones del componente (el segundo parámetro del `app.component()`):
```javascript
export default{
    props: ['todo'],
    template: 
...
Declarar los componentes con `app.component()` en el mismo fichero JS de la instancia como hicimos en el tema anterior genera varios problemas:
...
* lo registra como dependencia en el _package.json_
