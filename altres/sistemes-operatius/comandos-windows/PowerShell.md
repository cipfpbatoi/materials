...
- `Set-ADAccountPassword -Identity 'CN=Juan Segura,OU=1rCurs,OU=ASIX,DC=BATOI,DC=LAN' -Reset -NewPassword (ConvertTo-SecureString -AsPlainText "p@ssw0rd" -Force)`: hace lo mismo pero identifica al usuario por su nombre en lugar de por su login
