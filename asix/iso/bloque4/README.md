...
- **Microsoft Learn — Supervisión del rendimiento en Windows Server:**
  https://learn.microsoft.com/es-es/training/modules/monitor-windows-server-performance/

- **Microsoft Learn — Directivas de auditoría de seguridad avanzada:**
  https://learn.microsoft.com/es-es/windows/security/threat-protection/auditing/planning-and-deploying-advanced-security-audit-policies

- **Microsoft Learn — Auditoría de objetos en Active Directory:**
  https://learn.microsoft.com/es-es/troubleshoot/windows-server/windows-security/use-audit-active-directory-objects-track-events

- **Repositorio ASIR-ISO (GitHub — aberlanas):**
  https://github.com/aberlanas/ASIR-ISO

- **Apuntes ISO CIPFP Batoi:**
  https://cipfpbatoi.github.io/materials/asix/iso/